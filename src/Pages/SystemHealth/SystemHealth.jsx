...
const SystemHealth = ({show}) => {
    return (
      ...
      <div className="flex items-center justify-between bg-[#460073] p-4 rounded-md shadow-md">
        <h1 className="text-2xl font-bold">System Health and Reporting</h1>
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-gray-800 p-4 rounded-md shadow-md">
          ...
          <p className="text-sm text-gray-400">Monitor CPU, Memory, and Network Usage</p>
          <div className="mt-4">
            <div className="mb-2">
              <span className="font-medium">CPU Usage:</span>
              <div className="w-full bg-gray-600 rounded-full h-4 mt-1">
                <div className="bg-[#460073] h-4 rounded-full" style={{ width: '65%' }}></div>
              </div>
            ...
            <div className="mb-2">
              ...
              <div className="w-full bg-gray-600 rounded-full h-4 mt-1">
                <div className="bg-[#460073] h-4 rounded-full" style={{ width: '45%' }}></div>
              </div>
            ...
            <div className="mb-2">
              ...
              <div className="w-full bg-gray-600 rounded-full h-4 mt-1">
                <div className="bg-[#460073] h-4 rounded-full" style={{ width: '80%' }}></div>
              </div>
        ...
        <div className="bg-gray-800 p-4 rounded-md shadow-md">
          ...
          <p className="text-sm text-gray-400">Monitor the uptime of critical services</p>
        ...
        <div className="bg-gray-800 p-4 rounded-md shadow-md">
          ...
          <p className="text-sm text-gray-400">Identify and manage system issues</p>
        ...
        <div className="bg-gray-800 p-4 rounded-md shadow-md">
          ...
          <p className="text-sm text-gray-400">Run system diagnostics and checks</p>
        ...
        <div className="bg-gray-800 p-4 rounded-md shadow-md">
          ...
          <p className="text-sm text-gray-400">Manage automated recovery processes</p>
          <button className="w-full mt-4 bg-[#460073] py-2 rounded-md hover:bg-[#36005a] transition-colors">
            Initiate Recovery
          </button>
        </div>
